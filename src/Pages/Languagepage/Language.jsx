...
import Component1 from '../Languagepage/Component1'
import Component2 from '../Languagepage/Component2'
import Component3 from '../Languagepage/Component3'
import Component4 from '../Languagepage/Component4'
import Component5 from '../Languagepage/Component5'
import Component6 from '../Languagepage/Component6'
import Component7 from '../Languagepage/Component7'
...
const Language = () => {
  ...
  return (
    ...
    <div className='h-[615px] md:grid grid-cols-2 md:py-10' style={{ backgroundImage:`url(${Vector1})` , backgroundSize:"cover" , backgroundPosition:"center"}}>
      
    <div className='w-[80%] text-white py-10 lg:mt-[15%] ml-[14%] md:mt-10 '>
        <h1 className='text-[20px] md:text-[24px] lg:text-[48px] font-bold'>Professional & Native Chinese Translations</h1> 
    </div>
    ...
    <form ref={form} onSubmit={handleSubmit}>
            <div className='ml-[45px] md:ml-[1%] p-4 mt-10 lg:ml-[50%] w-[80%] md:w-[85%]  lg:w-[150%] lg:h-[500px] lg:mt-[-50%] rounded-xl bg-white '>
                ...
                <div className='relative mt-2 lg:mt-4'>
                  <div className='absolute'>
                    ...
                    <input className='border-2 py-2 w-[100%] md:w-[100%] lg:w-[100%] px-10 rounded-lg outline-none' name='phone' type="text" placeholder='E-mail'  required />
                </div>
                <div className='relative mt-2 lg:mt-4'>
                  <div className='absolute'>

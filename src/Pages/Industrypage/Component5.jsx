...
const Component5 = () => {
  return (
    ...
    <div className='h-[1150px] lg:h-[1000px]' style={{ backgroundImage: `url(${Vector2})`, backgroundSize: "cover", backgroundPosition: "center" }}>

    <div className='h-[990px] md:h-[950px] lg:h-[650px]  py-10 '>
        <div className='lg:grid grid-cols-2 lg:mt-32 '>
            <div className='lg:mt-[-10%]'>
                <div className=' lg:w-[300px] lg:ml-[10%] text-white '>
                    <h3 className='text-[24px] md:text-[30px] text-center lg:text-[36px]  mt-16 font-medium'>Businesses love  working with us</h3>
                </div>

                <div className='grid grid-cols-2 mt-5  w-[400px] ml-[25px] md:ml-[13%] md:w-[700px] lg:w-[550px] lg:ml-[13%] h-[250px]  '>
            ...
            <div className=''>
                <div className='ml-[20px] md:ml-[12%] h-[100px] w-[380px] md:w-[500px] p-4 rounded-xl shadow-xl bg-white'>
                    <img className='md:h-[45px] md:ml-2' src={user1} alt="" />
                    <h4 className='font-medium text-[16px] mt-[-16%] ml-[20%] md:mt-[-10%] md:ml-[16%]'>Floyd Miles</h4>
                    <img className='h-[18px] md:h-[20px]  ml-[20%] md:ml-[16%]' src={star} alt="" />
                    <p className='text-[#697587] text-[14px]  ml-[20%] md:ml-[16%]'>“Very quick and easy! Great service, thanks!”</p>
                </div>
                <div className='mt-8 ml-[20px] md:ml-[12%] h-[150px] md:h-[130px] w-[380px] md:w-[500px] p-4 rounded-xl shadow-xl bg-white'>
                    <img className='md:h-[45px] md:ml-2' src={user2} alt="" />
                    <h4 className='font-medium text-[16px] mt-[-16%] ml-[20%] md:mt-[-11%] md:ml-[16%]'>Arlene McCoy</h4>
                    <img className='h-[18px] md:h-[20px]  ml-[20%] md:ml-[16%]' src={star} alt="" />
                ...
                <div className='mt-8 ml-[20px] md:ml-[12%] h-[150px] md:h-[140px] w-[380px] md:w-[500px] p-4 rounded-xl shadow-xl bg-white'>
                    <img className='md:h-[45px] md:ml-2' src={user3} alt="" />
                    <h4 className='font-medium text-[16px] mt-[-16%] ml-[20%] md:mt-[-11%] md:ml-[16%]'>Leslie Alexander</h4>
                    <img className='h-[18px] md:h-[20px]  ml-[20%] md:ml-[16%]' src={star} alt="" />
                ...
                <div className='mt-8 ml-[20px] md:ml-[12%] h-[150px] md:h-[130px] w-[380px] md:w-[500px] p-4 rounded-xl shadow-xl bg-white'>
                    ...
                    <h4 className='font-medium text-[16px] mt-[-16%] ml-[20%] md:mt-[-11%] md:ml-[16%]'>Marvin McKinney</h4>
                    <img className='h-[18px] md:h-[20px]  ml-[20%] md:ml-[16%]' src={star} alt="" />

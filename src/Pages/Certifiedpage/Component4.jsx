...
const Component4 = () => {
  return (
    ...
    <div className=' h-auto pb-14 lg:pb-16'>
    ...
    <div>
      ...
      <div className='ml-28 mt-[10%] md:ml-[58%] md:mt-[6%] lg:ml-[56%] lg:mt-[2%]'>
      ...
      <div className='ml-28 mt-[16%] md:ml-[2%] md:mt-[8%] lg:ml-[12%] lg:mt-[6%]'>
        <div className='h-auto w-[90%]  md:w-[41%]  lg:w-[35%] bg-white rounded-lg shadow-lg'>
            <div className='ml-4 py-2'>
      ...
      <div className='ml-28 mt-[10%] md:ml-[58%] md:mt-[8%] lg:ml-[56%] lg:mt-[5%]'>
        <div className='h-auto w-[90%]  md:w-[90%] lg:w-[77%] bg-white rounded-lg shadow-lg'>
            <div className='ml-4 py-2'>

...
const Component5 = () => {
    return (
        <div className='h-auto lg:h-[1000px]' style={{ backgroundImage: `url(${Vector2})`, backgroundSize: "cover", backgroundPosition: "center" }}>

            <div className='md:flex py-20 lg:py-48 '>

                <div className='md:w-[50%]'>
                    <img className='h-[220px] md:h-[250px] lg:h-[400px] ml-24' src={Qimg} alt="" />
                </div>
                <div className='  md:w-[50%] ml-[20px] md:ml-0 py-10 md:mt-[-40px] text-white'>

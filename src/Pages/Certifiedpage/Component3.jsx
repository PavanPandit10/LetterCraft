...
const Component3 = () => {
  return (
    <div className='h-auto pb-10 lg:h-[1000px] '  style={{ backgroundImage:`url(${Vector2})` , backgroundSize:"cover" , backgroundPosition:"center"}}>
      
      
        <div className='lg:grid grid-cols-2 py-10 pb-10 lg:py-40 '>
       <div className=''>
